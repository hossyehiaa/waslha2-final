    ...
    <div className="flex flex-col h-full">
      <div className="h-16 flex items-center px-5 border-b border-sidebar-border shrink-0">
        <Link href="/" className="flex items-center gap-2.5">
          <img src="/wsalhali-logo-light.png" alt="Wslahali" className="h-9 w-auto object-contain shrink-0" />
          <span className="text-base font-bold tracking-tight text-sidebar-foreground">{dict.common.appName}</span>
        </Link>
      </div>
