...
import { FileText, Plus, Edit, Trash2, MoreVertical, X } from 'lucide-react'
...
export default function Page() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      const url = isEdit ? '/api/admin/cancel-reasons' : '/api/admin/cancel-reasons'
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="أسباب الإلغاء والتأجيل"
        subtitle="إدارة أسباب إلغاء وتأجيل الشحنات"
        icon={FileText}
        actions={
            ...
            >
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label>السبب</Label>
                  <Input value={form['reason'] || ''} onChange={(e) => setForm({ ...form, 'reason': e.target.value })} placeholder="العميل غير موجود" />
                </div>
                <div className="space-y-2">
                  <Label>النوع</Label>
                  <Select value={form['type'] || ''} onValueChange={(v) => setForm({ ...form, 'type': v })}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="POSTPONE">تأجيل</SelectItem>
      ...
      <ConfirmDialog
        ...
        title="تأكيد الحذف"
        description={'هل أنت متأكد من حذف ' + (deleteTarget?.reason || '') + '؟'}
